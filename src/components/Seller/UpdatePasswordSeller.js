...
import { updateSellerPassword, clearSellerErrors } from '../../actions/sellerAction';
...
const UpdatePasswordSeller = () => {
  ...
  const navigate = useNavigate();
    //console.log(token);
  const { error, success, loading } = useSelector((state) => state.updatePasswordSeller);
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      dispatch(updateSellerPassword(values.oldPassword, values.newPassword, values.confirmPassword));
