...
import { resetPassword, clearSellerErrors } from '../../actions/sellerAction';
...
import { RESET_PASSWORD_RESET } from '../../constants/sellerConstants';
...
const ResetPasswordSeller = () => {
  ...
  const { error, success, loading } = useSelector((state) => state.resetPasswordSeller);
