...
import { resetPassword, clearAdminErrors } from '../../actions/adminAction';
...
// import { RESET_PASSWORD_RESET } from '../../constants/adminConstants';
...
const ResetPasswordAdmin = () => {
  ...
  const { error, success, loading } = useSelector((state) => state.ResetPasswordAdmin);
